...
contract  NFTMarket is ERC721URIStorage,Ownable {
  ...
  function getOwnedNFTIndexs()public view returns( uint[] memory){
    ...
    function listNFT(uint tokenId,uint newPrice)public payable{
      ...
      allNfts[tokenIndex-1].isListed=true;
      allNfts[tokenIndex-1].price = newPrice;
    ...
    function unlistNft(uint tokenId) public{
      ...
      allNfts[tokenIndex - 1].isListed=false;
    }
    ...
    function getNftMintingFee()public view returns(uint){
      return mintPrice;
    }
